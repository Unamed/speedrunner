package  
{
	...
	public class MainMenuState extends FlxState
	{
		...
		public function MainMenuState() 
		{
			...
			_t1 = new FlxText(FlxG.width,FlxG.height/3,150,"SPEED");
			_t1.size = 32;
			_t1.color = 0x3a5c39;
			_t1.antialiasing = true;
			add(_t1);

			_t2 = new FlxText(-60,FlxG.height/3,200,"RUNNER");
			_t2.size = _t1.size;
			_t2.color = _t1.color;
			...
			var save:FlxSave = new FlxSave("SpeedRunner");
		...
		override public function update():void
		{
			...
			var t1m2:uint = FlxG.width / 2 - 154;
			
			if(_t1.x > t1m2)
			{
				_t1.x -= FlxG.elapsed*FlxG.width;
				if(_t1.x < t1m2) _t1.x = t1m2;
			}
