package SWFStats
{
	...
	public final class PlayerLevels
	{
		...
		public static function Save(level:PlayerLevel, thumb:DisplayObject, callback:Function):Boolean
		{
			...
			var request:URLRequest = new URLRequest("http://utils.swfstats.com/playerlevels/save.aspx?swfid=" + Log.SWFID + "&guid=" + Log.GUID + "&playerid=" + level.PlayerId + "&playersource=" + escape(level.PlayerSource) + "&playername=" + escape(level.PlayerName) + "&name=" + escape(level.Name) + "&customfields=" + customfields);
