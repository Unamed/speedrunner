	...
	public class FlxG
	{
		...
		static internal function doFollow():void
		{
			if(followTarget != null)
			{
				...
				{
					_scrollTarget.x = (width>>1)-followTarget.x+cameraOffset.x-(followTarget.width>>1)+(followTarget as FlxSprite).offset.x;
					_scrollTarget.y = (height>>1)-followTarget.y+cameraOffset.y-(followTarget.height>>1)+(followTarget as FlxSprite).offset.y;
